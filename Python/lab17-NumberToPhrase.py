...
tens = ['x','xx','twenty','thirty','forty','fifty','sixty','seventy','eighty','ninety']
hundred = ['hundred and']
...
def the_tens(num):
    if num < 10:
        ...
        if ones == 0:
            ...
            return tens[thetens] + ones[theones]


def the_hundreds(num):
    pass


number = int(input('What is the number you want spelled out? '))

if number < 100:
    print(the_tens(number))
...
#         print('- nine')
#
# translate = input('What number between 0-999 do you want translated into its English representation? ')
# number = []
...
#### Below was hashed out before the above code which was redone.
